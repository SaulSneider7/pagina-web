    ...
    <form action="registrar.php" method="post">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title">
                    <h3 class="card-title"><i class="fas fa-user"></i>&nbsp;&nbsp;Registrar Nuevo Usuario</h3>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" maxlength="150" size="50" class="form-control"
                                autocomplete="none" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                        </div>

                        <div class="form-group">
                            <label for="apellido">Apellido:</label>
                            <input type="text" name="apellido" maxlength="150" size="50" class="form-control"
                                autocomplete="none" onkeyup="javascript:this.value=this.value.toUpperCase();" />
                        </div>

                        <div class="form-group">
                            <label for="email">User:</label>
                            <input type="text" name="email" maxlength="120" size="50" class="form-control"
                                autocomplete="none" />
                        </div>
                        <div class="form-group">
                            <label for="contraseña">Contraseña:</label>
                            <input type="password" name="Contraseña" maxlength="120" size="50" class="form-control"
                                autocomplete="none" />
                        </div>

                        <div class="form-group">
                            <label for="numerodoc">Documento de Identidad:</label>
                            <input type="text" name="numerodoc" maxlength="8" size="8" class="form-control"
                                autocomplete="none" />
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="movil" maxlength="9" size="20" class="form-control"
                                autocomplete="none" />
                        </div>

                        <div class="form-group">
                            <label for="fechanac">Direccion:</label>
                            <input type="text" name="direccion" maxlength="300" size="180" class="form-control"
